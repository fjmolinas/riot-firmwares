...
enum {
    TFT_DISPLAY_LED = 0x00,
    TFT_DISPLAY_TEMP = 0x01,
    TFT_DISPLAY_TRIGGER = 0x02,
    TFT_DISPLAY_MANIFEST = 0x03,
    TFT_DISPLAY_FIRMWARE = 0x04,
    TFT_DISPLAY_END = 0x05,
    TFT_DISPLAY_SIZE = 0x06,
    TFT_DISPLAY_SIZE_UPDATE = 0x07,
};
